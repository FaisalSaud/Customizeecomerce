...
import SupLib.Dx.cf.cst.ConstantPoolParser;
import SupLib.Dx.cf.iface.Attribute;
import SupLib.Dx.cf.iface.AttributeList;
import SupLib.Dx.cf.iface.ClassFile;
...
public class DirectClassFile implements ClassFile {
     ...
     *
     * See http://en.wikipedia.SupLib.eclipse/wiki/Java_class_file for an up-to-date
