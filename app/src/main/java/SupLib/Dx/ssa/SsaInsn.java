...
import SupLib.Dx.rop.code.*;
import SupLib.Dx.util.ToHuman;
...
public abstract class SsaInsn implements ToHuman, Cloneable {
    ...
    /**
     * Like {@link SupLib.Dx.rop.code.Insn getResult()}.
     *
    ...
    /**
     * Like {@link SupLib.Dx.rop.code.Insn getSources()}.
     *
     ...
     *
     * @see SupLib.Dx.rop.code.Insn#getLocalAssignment()
     *
