...
/**
 * An adaptor for accessing connection parameters in {@link org.apache.http.params.HttpParams}.
 * <br/>
 * Note that the <i>implements</i> relation to {@link org.apache.http.params.CoreConnectionPNames}
...
public final class HttpConnectionParams implements org.apache.http.params.CoreConnectionPNames {
     ...
     */
    public static int getSoTimeout(final org.apache.http.params.HttpParams params) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
        return params.getIntParameter(org.apache.http.params.CoreConnectionPNames.SO_TIMEOUT, 0);
    }
     ...
     */
    public static void setSoTimeout(final org.apache.http.params.HttpParams params, int timeout) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
        params.setIntParameter(org.apache.http.params.CoreConnectionPNames.SO_TIMEOUT, timeout);
     ...
     */
    public static boolean getTcpNoDelay(final org.apache.http.params.HttpParams params) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
        return params.getBooleanParameter
            (org.apache.http.params.CoreConnectionPNames.TCP_NODELAY, true);
    }
     ...
     *   (that is enable TCP_NODELAY), <tt>false</tt> otherwise.
     */
    public static void setTcpNoDelay(final org.apache.http.params.HttpParams params, boolean value) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
        params.setBooleanParameter(org.apache.http.params.CoreConnectionPNames.TCP_NODELAY, value);
    }

    public static int getSocketBufferSize(final org.apache.http.params.HttpParams params) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
        return params.getIntParameter
            (org.apache.http.params.CoreConnectionPNames.SOCKET_BUFFER_SIZE, -1);
    }
    
    public static void setSocketBufferSize(final org.apache.http.params.HttpParams params, int size) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
        params.setIntParameter(org.apache.http.params.CoreConnectionPNames.SOCKET_BUFFER_SIZE, size);
    }
     ...
     */
    public static int getLinger(final org.apache.http.params.HttpParams params) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
        return params.getIntParameter(org.apache.http.params.CoreConnectionPNames.SO_LINGER, -1);
    }
     ...
     */
    public static void setLinger(final org.apache.http.params.HttpParams params, int value) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
        params.setIntParameter(org.apache.http.params.CoreConnectionPNames.SO_LINGER, value);
    }
     ...
     * @return timeout in milliseconds.
     */
    public static int getConnectionTimeout(final org.apache.http.params.HttpParams params) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
        return params.getIntParameter
     ...
     * @param timeout Timeout in milliseconds.
     */
    public static void setConnectionTimeout(final org.apache.http.params.HttpParams params, int timeout) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
     ...
     */
    public static boolean isStaleCheckingEnabled(final org.apache.http.params.HttpParams params) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
        return params.getBooleanParameter
            (org.apache.http.params.CoreConnectionPNames.STALE_CONNECTION_CHECK, true);
    }
     ...
     *   <tt>false</tt> otherwise.
     */
    public static void setStaleCheckingEnabled(final org.apache.http.params.HttpParams params, boolean value) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
