...
/**
 * This class implements an adaptor around the {@link org.apache.http.params.HttpParams} interface
...
public final class HttpProtocolParams implements CoreProtocolPNames {
     ...
     * @return The charset
     */
    public static String getHttpElementCharset(final org.apache.http.params.HttpParams params) {
        if (params == null) {
     ...
     */
    public static void setHttpElementCharset(final org.apache.http.params.HttpParams params, final String charset) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
     ...
     * @return The charset
     */
    public static String getContentCharset(final org.apache.http.params.HttpParams params) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
        String charset = (String) params.getParameter
     ...
     * @param charset The charset
     */
    public static void setContentCharset(final org.apache.http.params.HttpParams params, final String charset) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
     ...
     */
    public static ProtocolVersion getVersion(final org.apache.http.params.HttpParams params) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
     ...
     */
    public static void setVersion(final org.apache.http.params.HttpParams params, final ProtocolVersion version) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
    ...
    public static String getUserAgent(final org.apache.http.params.HttpParams params) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
    ...
    public static void setUserAgent(final org.apache.http.params.HttpParams params, final String useragent) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
    ...
    public static boolean useExpectContinue(final org.apache.http.params.HttpParams params) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
    ...
    public static void setUseExpectContinue(final org.apache.http.params.HttpParams params, boolean b) {
        if (params == null) {
            throw new IllegalArgumentException("HTTP parameters may not be null");
        }
