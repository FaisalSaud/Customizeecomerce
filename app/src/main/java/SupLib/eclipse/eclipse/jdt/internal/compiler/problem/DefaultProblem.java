...
public class DefaultProblem extends CategorizedProblem {
	...
	private static final String MARKER_TYPE_PROBLEM = "SupLib.eclipse.eclipse.jdt.core.problem"; //$NON-NLS-1$
	private static final String MARKER_TYPE_TASK = "SupLib.eclipse.eclipse.jdt.core.task"; //$NON-NLS-1$
...
/**
 * @see SupLib.eclipse.eclipse.jdt.core.compiler.CategorizedProblem#getCategoryID()
 */
 ...
 * @see SupLib.eclipse.eclipse.jdt.core.compiler.IProblem#getID()
 * @return int
 */
public int getID() {
	return this.id;
 ...
 * @see SupLib.eclipse.eclipse.jdt.core.compiler.CategorizedProblem#getMarkerType()
 */
