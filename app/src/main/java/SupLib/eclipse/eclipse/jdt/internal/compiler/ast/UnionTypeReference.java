...
public class UnionTypeReference extends TypeReference {
	...
	/* (non-Javadoc)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.ast.TypeReference#getLastToken()
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ArrayQualifiedTypeReference#getTypeBinding(SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.Scope)
	 */
	...
	public TypeBinding resolveType(BlockScope scope, boolean checkBounds) {
		...
		for (int i = 0; i < length; i++) {
			...
			// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=340486, ensure types are of union type.
			for (int j = 0; j < i; j++) {
	...
	/* (non-Javadoc)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.ast.TypeReference#traverse(SupLib.eclipse.eclipse.jdt.internal.compiler.ASTVisitor, SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.BlockScope)
	 */
	...
	/* (non-Javadoc)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.ast.TypeReference#traverse(SupLib.eclipse.eclipse.jdt.internal.compiler.ASTVisitor, SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ClassScope)
	 */
	...
	/* (non-Javadoc)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.ast.Expression#printExpression(int, java.lang.StringBuffer)
	 */
