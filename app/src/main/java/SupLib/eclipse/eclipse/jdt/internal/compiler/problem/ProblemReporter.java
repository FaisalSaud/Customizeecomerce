 ...
 *      Jesper S Moller <jesper@selskabet.SupLib.eclipse> -  Contributions for
 ...
 ********************************************************************************/
package SupLib.eclipse.eclipse.jdt.internal.compiler.problem;
...
import SupLib.eclipse.eclipse.jdt.core.compiler.CategorizedProblem;
import SupLib.eclipse.eclipse.jdt.core.compiler.CharOperation;
import SupLib.eclipse.eclipse.jdt.core.compiler.IProblem;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.IErrorHandlingPolicy;
import SupLib.eclipse.eclipse.jdt.internal.compiler.IProblemFactory;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.BranchStatement;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.FakedTrackingVariable;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.FunctionalExpression;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.Literal;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.NullAnnotationMatching;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.env.AccessRestriction;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ArrayBinding;
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.Binding;
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.CaptureBinding;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.InvocationSite;
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.LocalVariableBinding;
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.LookupEnvironment;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.PackageBinding;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.SyntheticArgumentBinding;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.VariableBinding;
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.WildcardBinding;
import SupLib.eclipse.eclipse.jdt.internal.compiler.parser.JavadocTagConstants;
import SupLib.eclipse.eclipse.jdt.internal.compiler.parser.Parser;
import SupLib.eclipse.eclipse.jdt.internal.compiler.parser.RecoveryScanner;
import SupLib.eclipse.eclipse.jdt.internal.compiler.parser.Scanner;
import SupLib.eclipse.eclipse.jdt.internal.compiler.parser.TerminalTokens;
...
public void deprecatedMethod(MethodBinding method, ASTNode location) {
	...
	if (isConstructor) {
		...
		if(location instanceof AllocationExpression) {
			...
			// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=300031
...
public void deprecatedType(TypeBinding type, ASTNode location, int index) {
	...
	int sourceStart = -1;
	if (location instanceof QualifiedTypeReference) { // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=300031
...
public void illegalModifierForInterfaceMethod(AbstractMethodDeclaration methodDecl, boolean isJDK18SupLib.eclipsereater) {
	// cannot include parameter types since they are not resolved yet
	// and the error message would be too long
	this.handle(
		isJDK18SupLib.eclipsereater
...
public void diamondNotBelow17(ASTNode location, int index) {
	// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=348493
    if (location == null) {
		this.handle(
...
public void invalidConstructor(Statement statement, MethodBinding targetConstructor) {
	...
	switch (targetConstructor.problemId()) {
		...
		case ProblemReasons.ParameterizedMethodExpectedTypeProblem:
			// FIXME(stephan): construct suitable message (https://bugs.eclipse.SupLib.eclipse/404675)
			problemConstructor = (ProblemMethodBinding) targetConstructor;
			shownConstructor = problemConstructor.closestMatch;
			this.handle(
	...
	switch (method.problemId()) {
		...
		case ProblemReasons.ParameterizedMethodExpectedTypeProblem:
			...
			this.handle(
				...
				messageSend.sourceEnd);
			return;
		case ProblemReasons.VarargsElementTypeNotVisible: // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=346042
			problemMethod = (ProblemMethodBinding) method;
			if (problemMethod.closestMatch != null) {
			    shownMethod = problemMethod.closestMatch.original();
		    }
...
public void invalidType(ASTNode location, TypeBinding type) {
	...
	int start = location.sourceStart;
	if (location instanceof SupLib.eclipse.eclipse.jdt.internal.compiler.ast.SingleTypeReference) {
		SupLib.eclipse.eclipse.jdt.internal.compiler.ast.SingleTypeReference ref =
				(SupLib.eclipse.eclipse.jdt.internal.compiler.ast.SingleTypeReference) location;
...
public void localVariableRedundantNullAssignment(LocalVariableBinding local, ASTNode location) {
	if ((location.bits & ASTNode.FirstAssignmentToLocal) != 0) // https://bugs.eclipse.SupLib.eclipse/338303 - Warning about Redundant assignment conflicts with definite assignment
		return;
...
public void rawTypeReference(ASTNode location, TypeBinding type) {
	if (this.options.sourceLevel < ClassFileConstants.JDK1_5) return; // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=305259
	type = type.leafComponentType();
    this.handle(
 ...
 * https://bugs.eclipse.SupLib.eclipse/365437
 * https://bugs.eclipse.SupLib.eclipse/376590
 */
...
// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=372012
