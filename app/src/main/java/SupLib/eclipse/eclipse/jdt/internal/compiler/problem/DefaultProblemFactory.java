...
public final String getLocalizedMessage(int id, int elaborationId, String[] problemArguments) {
	...
	// see https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=120410
...
public static HashtableOfInt loadMessageTemplates(Locale loc) {
	...
	String bundleName = "SupLib.eclipse.eclipse.jdt.internal.compiler.problem.messages"; //$NON-NLS-1$
	try {
