...
import SupLib.eclipse.eclipse.jdt.internal.compiler.classfmt.ExternalAnnotationProvider.IMethodAnnotationWalker;
import SupLib.eclipse.eclipse.jdt.internal.compiler.classfmt.NonNullDefaultAwareTypeAnnotationWalker;
import SupLib.eclipse.eclipse.jdt.internal.compiler.classfmt.TypeAnnotationWalker;
import SupLib.eclipse.eclipse.jdt.internal.compiler.codegen.ConstantPool;
import SupLib.eclipse.eclipse.jdt.internal.compiler.env.*;
...
public class BinaryTypeBinding extends ReferenceBinding {
	...
	*/
	...
	/* https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=324850, even in a 1.4 project, we
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#availableFields()
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#availableMethods()
	 */
	...
	private MethodBinding createMethod(IBinaryMethod method, IBinaryType binaryType, long sourceLevel, char[][][] missingTypeNames) {
		...
		if (isInterface() && (methodModifiers & ClassFileConstants.AccAbstract) == 0) {
			// see https://bugs.eclipse.SupLib.eclipse/388954 superseded by https://bugs.eclipse.SupLib.eclipse/390889
	...
	/* https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=324850, Since a 1.4 project can have a 1.5
	...
	private IBinaryMethod[] createMethods(IBinaryMethod[] iMethods, IBinaryType binaryType, long sourceLevel, char[][][] missingTypeNames) {
		...
		if (iMethods != null) {
			...
			boolean keepBridgeMethods = sourceLevel < ClassFileConstants.JDK1_5; // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=330347
			for (int i = total; --i >= 0;) {
													  ...
													  ITypeAnnotationWalker walker, boolean isClassTypeParameter)
	{
		...
		// see https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=163680
		if (assignVariables)
...
// The suggested parameter length is optional and may not be guaranteed by every type.
	...
	public boolean isEquivalentTo(TypeBinding otherType) {
		...
		/* With the hybrid 1.4/1.5+ projects modes, while establishing type equivalence, we need to
	       ...
	       not. See https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=186565 && https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=328827
		*/
    ...
    */
	public ReferenceBinding superclass() {
		...
		if (this.superclass.problemId() == ProblemReasons.NotFound) {
			...
			boolean wasToleratingMissingTypeProcessingAnnotations = this.environment.mayTolerateMissingType;
			this.environment.mayTolerateMissingType = true; // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=360164
			try {
