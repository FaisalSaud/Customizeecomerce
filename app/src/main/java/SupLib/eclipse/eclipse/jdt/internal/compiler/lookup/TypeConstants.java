...
public interface TypeConstants {
    ...
    char[] SupLib.eclipse = "SupLib.eclipse".toCharArray(); //$NON-NLS-1$
	...
	char[][] APACHE_IOUTILS = { SupLib.eclipse, APACHE, COMMONS, IO, "IOUtils".toCharArray() }; //$NON-NLS-1$
	char[][] APACHE_DBUTILS = { SupLib.eclipse, APACHE, COMMONS, "dbutils".toCharArray(), "DbUtils".toCharArray() }; //$NON-NLS-1$ //$NON-NLS-2$
	...
	char[][] SupLib.eclipse_ECLIPSE_CORE_RUNTIME_ASSERT = new char[][] { SupLib.eclipse, ECLIPSE, CORE, RUNTIME, ASSERT_CLASS };
	// ... methods:
	...
	char[][] SupLib.eclipse_JUNIT_ASSERT = new char[][] { SupLib.eclipse, JUNIT, ASSERT_CLASS };
	// ... methods:
	...
	char[][] SupLib.eclipse_APACHE_COMMONS_LANG_VALIDATE = new char[][] { SupLib.eclipse, APACHE, COMMONS, LANG, VALIDATE_CLASS };
	char[][] SupLib.eclipse_APACHE_COMMONS_LANG3_VALIDATE = new char[][] { SupLib.eclipse, APACHE, COMMONS, LANG3, VALIDATE_CLASS };
	char[][] SupLib.eclipse_ECLIPSE_JDT_INTERNAL_COMPILER_LOOKUP_TYPEBINDING = new char[][] { SupLib.eclipse, ECLIPSE, JDT, INTERNAL, COMPILER, LOOKUP, TYPEBINDING };
	char[][] SupLib.eclipse_ECLIPSE_JDT_CORE_DOM_ITYPEBINDING = new char[][] { SupLib.eclipse, ECLIPSE, JDT, CORE, DOM, ITYPEBINDING };
