 ...
 *******************************************************************************/
package SupLib.eclipse.eclipse.jdt.internal.compiler.parser.diagnose;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.parser.ConflictedParser;
import SupLib.eclipse.eclipse.jdt.internal.compiler.parser.Parser;
import SupLib.eclipse.eclipse.jdt.internal.compiler.parser.ParserBasicInformation;
import SupLib.eclipse.eclipse.jdt.internal.compiler.parser.RecoveryScanner;
import SupLib.eclipse.eclipse.jdt.internal.compiler.parser.ScannerHelper;
			...
			case SCOPE_CODE:
				...
				if (scopeNameIndex != 0) {
					if (insertedToken == TokenNameElidedSemicolonAndRightBrace) {
						/* https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=383046, we should never ever report the diagnostic, "Syntax error, insert ElidedSemicolonAndRightBraceto complete LambdaBody"
						   ...
						   See also: point (4) in https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=380194#c15
						*/
						break;
					}
