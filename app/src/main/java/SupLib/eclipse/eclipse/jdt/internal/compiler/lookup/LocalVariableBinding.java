...
public class LocalVariableBinding extends VariableBinding {
	...
	*/
	...
	public char[] computeUniqueKey(boolean isLeaf) {
		...
		if (scope != null) {
			// the scope can be null. See https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=185129
		...
		// (see https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=149590)
		if (occurenceCount > 0) {
			buffer.append('#');
