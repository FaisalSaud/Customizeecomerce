 ...
 *     Tom Tromey - patch for readTable(String) as described in http://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=32196
 ...
 *******************************************************************************/
package SupLib.eclipse.eclipse.jdt.internal.compiler.parser;
...
import SupLib.eclipse.eclipse.jdt.core.compiler.InvalidInputException;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ASTVisitor;
import SupLib.eclipse.eclipse.jdt.internal.compiler.CompilationResult;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.AND_AND_Expression;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ASTNode;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.AbstractMethodDeclaration;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.AbstractVariableDeclaration;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.AllocationExpression;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.Annotation;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.AnnotationMethodDeclaration;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.Argument;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ArrayAllocationExpression;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ArrayInitializer;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ArrayQualifiedTypeReference;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ArrayReference;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ArrayTypeReference;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.AssertStatement;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.Assignment;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.BinaryExpression;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.Block;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.BreakStatement;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.CaseStatement;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.CastExpression;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.CharLiteral;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ClassLiteralAccess;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.CombinedBinaryExpression;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.CompilationUnitDeclaration;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.CompoundAssignment;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ConditionalExpression;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ConstructorDeclaration;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ContinueStatement;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.DoStatement;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.DoubleLiteral;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.EmptyStatement;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.EqualExpression;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ExplicitConstructorCall;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.Expression;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.FalseLiteral;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.FieldDeclaration;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.FieldReference;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.FloatLiteral;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ForStatement;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ForeachStatement;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.IfStatement;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ImportReference;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.Initializer;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.InstanceOfExpression;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.IntLiteral;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.IntersectionCastTypeReference;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.Javadoc;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.LabeledStatement;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.LambdaExpression;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.LocalDeclaration;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.LongLiteral;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.MarkerAnnotation;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.MemberValuePair;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.MessageSend;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.MethodDeclaration;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.NameReference;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.NormalAnnotation;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.NullLiteral;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.OR_OR_Expression;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.OperatorIds;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ParameterizedQualifiedTypeReference;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ParameterizedSingleTypeReference;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.PostfixExpression;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.PrefixExpression;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.QualifiedAllocationExpression;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.QualifiedNameReference;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.QualifiedSuperReference;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.QualifiedThisReference;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.QualifiedTypeReference;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.Receiver;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.Reference;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ReferenceExpression;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ReturnStatement;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.SingleMemberAnnotation;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.SingleNameReference;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.SingleTypeReference;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.Statement;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.StringLiteral;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.SuperReference;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.SwitchStatement;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.SynchronizedStatement;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ThisReference;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.ThrowStatement;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.TrueLiteral;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.TryStatement;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.TypeDeclaration;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.TypeParameter;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.TypeReference;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.UnaryExpression;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.UnionTypeReference;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.WhileStatement;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.codegen.ConstantPool;
import SupLib.eclipse.eclipse.jdt.internal.compiler.env.ICompilationUnit;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.MethodScope;
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.TypeIds;
import SupLib.eclipse.eclipse.jdt.internal.compiler.parser.diagnose.DiagnoseParser;
import SupLib.eclipse.eclipse.jdt.internal.compiler.problem.AbortCompilation;
import SupLib.eclipse.eclipse.jdt.internal.compiler.problem.AbortCompilationUnit;
import SupLib.eclipse.eclipse.jdt.internal.compiler.problem.ProblemReporter;
import SupLib.eclipse.eclipse.jdt.internal.compiler.problem.ProblemSeverities;
import SupLib.eclipse.eclipse.jdt.internal.compiler.util.Messages;
...
public class Parser extends CommitRollbackParser implements ConflictedParser, OperatorIds, TypeIds {
	...
	public final static void buildFilesFromLPG(String dataFilename, String dataFilename2) {
		...
		//[SupLib.eclipse.eclipse.jdt.internal.compiler.parser.Parser.buildFilesFromLPG("d:/leapfrog/grammar/javadcl.java")]
...
public SupLib.eclipse.eclipse.jdt.internal.compiler.ReadManager readManager;
	...
	for(int i = 0; i <= this.astPtr; i++){
		...
		if (node instanceof TypeDeclaration){
			...
			if ((type.modifiers & ClassFileConstants.AccEnum) != 0) {
				...
				// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=340691
				continue;
			}
...
protected void checkForDiamond(TypeReference allocType) {
	if (allocType instanceof ParameterizedSingleTypeReference) {
		...
		if (type.typeArguments == TypeReference.NO_TYPE_ARGUMENTS) {
			...
			if (this.options.sourceLevel > ClassFileConstants.JDK1_4) { // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=351965
...
protected void consumeCatchFormalParameter() {
	...
	int extendedDimensions = this.intStack[this.intPtr--]; // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=348369
	...
	if (extendedDimensions > 0) {
		...
		// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=391092
...
protected void consumeEnhancedForStatementHeader(){
	...
	// https://bugs.eclipse.SupLib.eclipse/393719 - [compiler] inconsistent warnings on iteration variables
...
protected void consumeInterfaceDeclaration() {
	...
	// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=212713,
...
protected void consumeTypeAnnotation() {
	...
	this.dimensions = this.intStack[this.intPtr--]; // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=417660
}
...
protected void consumeNonTypeUseName() { // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=383596
...
//	}
	...
	switch (type) {
		...
		case TokenNamecase :
			...
			break;
		case TokenNamenew :
			// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=40954
			resetModifiers();
			pushOnIntStack(this.scanner.startPosition);
			break;
		case TokenNameclass :
		...
		case TokenNameAT308:
			...
			pushOnIntStack(this.dimensions); // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=417660: Stack the dimensions, they get unstacked in consumeTypeAnnotation.
			this.dimensions = 0;
			//$FALL-THROUGH$
		case TokenNameAT :
			pushOnIntStack(this.scanner.startPosition);
...
protected TypeReference getTypeReference(int dim) {
	...
	if (length < 0) { //flag for precompiled type reference on base types
		...
		if (length != numberOfIdentifiers || this.genericsLengthStack[this.genericsLengthPtr] != 0) {
			// generic type
			ref = getTypeReferenceFSupLib.eclipseenericType(dim, length, numberOfIdentifiers);
		} else if (length == 1) {
...
protected TypeReference getTypeReferenceFSupLib.eclipseenericType(int dim, int identifierLength, int numberOfIdentifiers) {
	Annotation[][] annotationsOnDimensions = dim == 0 ? null : getAnnotationsOnDimensions(dim);
	if (identifierLength == 1 && numberOfIdentifiers == 1) {
		...
		/* We used to eagerly mark the PSTR as constituting diamond usage if we encountered <>, but that is too eager and
		   ...
		   See https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=339478#c11
		*/
...
public void goFSupLib.eclipseenericMethodDeclaration(){
	...
	for (int i = this.astPtr; i >= 0; i--) {
		...
		if (node instanceof AbstractMethodDeclaration
				...
				|| (node instanceof TypeDeclaration // mark type for now: all initializers will be marked when added to this type
						// and enclosing type must not be closed (see https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=147485)
...
public ASTNode[] parseClassBodyDeclarations(char[] source, int offset, int length, CompilationUnitDeclaration unit) {
	...
	if (this.lastAct == ERROR_ACTION) {
		...
		if (this.astLengthPtr > -1 && (astLength = this.astLengthStack[this.astLengthPtr--]) != 0) {
			...
			// empty class body declaration (like ';' see https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=280079).
...
public void recoveryExitFromVariable() {
	if(this.currentElement != null && this.currentElement.parent != null) {
		if(this.currentElement instanceof RecoveredLocalVariable) {
			...
			// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=292087
...
protected void reportSyntaxErrors(boolean isDietParse, int oldFirstToken) {
	...
	if(isDietParse) {
		...
		int[][] intervalToSkip = SupLib.eclipse.eclipse.jdt.internal.compiler.parser.diagnose.RangeUtil.computeDietRange(types);
