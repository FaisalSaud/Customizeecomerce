...
public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
	...
	if (this.binding.declaringClass.isMemberType() && !this.binding.declaringClass.isStatic()) {
		...
		// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=335845
...
/**
 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.InvocationSite#invocationTargetType()
 */
