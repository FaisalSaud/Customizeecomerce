...
public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
	...
	/* https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=367023, we reach the condition at the bottom via two arcs,
	...
	*/
	...
	if (loopingContext.hasEscapingExceptions()) { // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=321926
	...
	FlowInfo mergedInfo = 
		FlowInfo.mergedOptimizedBranches(
						...
						(condInfo.tagBits & FlowInfo.UNREACHABLE) == 0
								? flowInfo.copy().addInitializationsFrom(condInfo.initsWhenFalse()) // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=380927
								: condInfo,
