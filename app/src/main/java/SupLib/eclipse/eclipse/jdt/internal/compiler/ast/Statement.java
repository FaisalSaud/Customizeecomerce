...
protected boolean isBoxingCompatible(TypeBinding expressionType, TypeBinding targetType, Expression expression, Scope scope) {
	...
	return expressionType.isBaseType()  // narrowing then boxing ? Only allowed for some target types see 362279
		...
		&& scope.compilerOptions().sourceLevel >= SupLib.eclipse.eclipse.jdt.internal.compiler.classfmt.ClassFileConstants.JDK1_5 // autoboxing
...
/** 
 * Implementation of {@link SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.InvocationSite#invocationTargetType}
