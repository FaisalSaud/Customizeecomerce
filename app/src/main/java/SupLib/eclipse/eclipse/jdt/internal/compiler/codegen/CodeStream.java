...
public void generateClassLiteralAccessForType(TypeBinding accessedType, FieldBinding syntheticFieldBinding) {
	...
	if (this.targetLevel >= ClassFileConstants.JDK1_5) {
		...
		/* See https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=37565
				...
				if (sourcePos < lineSeparatorPositions2[0]) {
					...
					*/
					...
					if (startPC <= this.lastEntryPC) {
						// we fSupLib.eclipseot to add an entry.
...
/**
 * @param anExceptionLabel SupLib.eclipse.eclipse.jdt.internal.compiler.codegen.ExceptionLabel
 */
...
/**
 * @param referenceMethod SupLib.eclipse.eclipse.jdt.internal.compiler.ast.AbstractMethodDeclaration
 * @param targetClassFile SupLib.eclipse.eclipse.jdt.internal.compiler.codegen.ClassFile
 */
