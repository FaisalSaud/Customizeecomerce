 ...
 * @return SupLib.eclipse.eclipse.jdt.internal.compiler.api.IBinaryField[]
 */
 ...
 *
 * @return SupLib.eclipse.eclipse.jdt.internal.compiler.api.IBinaryNestedType[]
 */
public IBinaryNestedType[] getMemberTypes() {
	...
	if (length != startingIndex) {
		...
		for (int i = startingIndex; i < length; i++) {
			 ...
			 * http://dev.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=14592
			 * we needed to add an extra check. So we check that innerNameIndex is different from 0 as well.
			 *
			 * https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=49879
 ...
 * @return SupLib.eclipse.eclipse.jdt.internal.compiler.api.env.IBinaryMethod[]
 */
