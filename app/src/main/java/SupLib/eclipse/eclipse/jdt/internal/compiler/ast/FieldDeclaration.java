...
/**
 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.ast.AbstractVariableDeclaration#getKind()
 */
public int getKind() {
	...
	if (classScope != null) {
		checkHiding: {
			...
			checkHidingSuperField: {
				...
				// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=318171, find field skipping visibility checks
