...
//	    		System.err.println("TODO(stephan): issue proper error: bound conflict at "+String.valueOf(this.declaringElement.readableName()));
	...
	public char[] computeUniqueKey(boolean isLeaf) {
		...
		if (!isLeaf && declaring.kind() == Binding.METHOD) { // see https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=97902
...
//	}
	...
	/**
     * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#readableName()
     */
...
//						System.err.println("TODO(stephan): report proper error: conflict binary TypeVariable vs. bound "+i);
	...
	/**
     * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#shortReadableName()
     */
