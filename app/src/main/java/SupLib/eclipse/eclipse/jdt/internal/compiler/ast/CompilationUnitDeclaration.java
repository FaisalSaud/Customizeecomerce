...
import SupLib.eclipse.eclipse.jdt.internal.compiler.impl.IrritantSet;
import SupLib.eclipse.eclipse.jdt.internal.compiler.impl.ReferenceContext;
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.CompilationUnitScope;
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ImportBinding;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.parser.NLSTag;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.util.HashSetOfInt;
...
public void resolve() {
	...
	if (this.types != null && isPackageInfo) {
		...
		// set empty javadoc to avoid missing warning (see bug https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=95286)
