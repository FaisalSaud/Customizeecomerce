...
public class JavadocReturnStatement extends ReturnStatement {
	...
	/* (non-Javadoc)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.ast.Statement#resolve(SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.BlockScope)
	 */
	...
	/* (non-Javadoc)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.ast.Statement#printStatement(int, java.lang.StringBuffer)
	 */
