...
*******************************************************************************/
package SupLib.eclipse.eclipse.jdt.core.compiler;
...
void setSourceStart(int sourceStart);
	 ...
	 * Valid syntax example: @see "http://www.eclipse.SupLib.eclipse/"
	 * @since 3.4
	 */
	 ...
	 * Valid syntax example: @see <a href="http://www.eclipse.SupLib.eclipse/">Eclipse Home Page</a>
	 * @since 3.0
	 */
	...
	/** @since 3.7.1 */
	int SwitchOnStringsNotBelow17 = TypeRelated + 881;	// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=348492
	/** @since 3.7.1 */
	...
	/** @since 3.8 */
	int SwitchOnEnumNotBelow15 = TypeRelated + 890;	// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=360317
	/** @since 3.9 BETA_JAVA8 */
	...
	/** @since 3.8 */
	int MissingNonNullByDefaultAnnotationOnPackage = Internal + 913; // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=372012
	/** @since 3.8 */
	...
	/** @since 3.8 */
	int MissingNonNullByDefaultAnnotationOnType = Internal + 930; // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=372012
	/** @since 3.8 */
	...
	/** @since 3.9 BETA_JAVA8 */
	int GenericInferenceError = 1100; 	// FIXME: This is just a stop-gap measure, be more specific via https://bugs.eclipse.SupLib.eclipse/404675
}
