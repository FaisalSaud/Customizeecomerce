...
//						}
	...
	public char[] computeUniqueKey(boolean isLeaf) {
		...
		char[] wildCardKey;
		// We now encode the rank also in the binding key - https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=234609
	...
	/**
     * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#isSuperclassOf(SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding)
     */
    ...
    /* (non-Javadoc)
     * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#sourceName()
     */
    ...
    /* (non-Javadoc)
     * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.TypeVariableBinding#superclass()
     */
