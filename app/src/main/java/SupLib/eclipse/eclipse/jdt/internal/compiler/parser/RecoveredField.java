			...
			for (int i = 0; i < this.anonymousTypeCount; i++){
				...
				if (recoveredType.preserveContent){
					...
					if (anonymousType != null) {
						...
						if (end > this.fieldDeclaration.declarationSourceEnd) { // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=307337
...
public RecoveredElement updateOnOpeningBrace(int braceStart, int braceEnd){
	if (this.fieldDeclaration.declarationSourceEnd == 0) {
		...
		} else {  // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=308980
