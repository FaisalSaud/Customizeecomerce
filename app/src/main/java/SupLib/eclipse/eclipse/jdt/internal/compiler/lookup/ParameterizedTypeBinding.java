...
public class ParameterizedTypeBinding extends ReferenceBinding implements Substitution {
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#canBeInstantiated()
	 */
	 ...
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.TypeBinding#capture(Scope,int)
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.TypeBinding#collectMissingTypes(List)
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#computeId()
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.TypeBinding#constantPoolName()
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.TypeBinding#debugName()
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#enclosingType()
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.Substitution#environment()
	 */
	public LookupEnvironment environment() {
	...
	/**
     * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.TypeBinding#erasure()
     */
    public TypeBinding erasure() {
        return this.type.erasure(); // erasure
    }
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#fieldCount()
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#fields()
	 */
	public FieldBinding[] fields() {
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#getAnnotationTagBits()
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#getExactConstructor(TypeBinding[])
	 */
	public MethodBinding getExactConstructor(TypeBinding[] argumentTypes) {
	 ...
	 /**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#getExactMethod(char[], TypeBinding[],CompilationUnitScope)
	 */
	public MethodBinding getExactMethod(char[] selector, TypeBinding[] argumentTypes, CompilationUnitScope refScope) {
	 ...
	 /**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#getField(char[], boolean)
	 */
	public FieldBinding getField(char[] fieldName, boolean needResolve) {
 	...
 	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#getMemberType(char[])
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#getMethods(char[])
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#implementsMethod(MethodBinding)
	 */
			...
			for (int i = 0, length = someArguments.length; i < length; i++) {
				...
				switch (someArgument.kind()) {
					...
					case Binding.INTERSECTION_TYPE :
						this.tagBits |= TagBits.HasDirectWildcard | TagBits.IsBoundParameterizedType; // Surely NOT X<?,?>, see https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=366131
						break;
					default :
						this.tagBits |= TagBits.IsBoundParameterizedType;
						break;
	...
	public boolean isEquivalentTo(TypeBinding otherType) {
	    ...
	    /* With the hybrid 1.4/1.5+ projects modes, while establishing type equivalence, we need to
	       ...
	       not. See https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=328827
	     */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.Substitution#isRawSubstitution()
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#memberTypes()
	 */
	public ReferenceBinding[] memberTypes() {
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#methods()
	 */
	public MethodBinding[] methods() {
		if ((this.tagBits & TagBits.AreMethodsComplete) != 0)
			return this.methods;
	 ...
	 *
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.Binding#problemId()
	 */
	public int problemId() {
		return this.type.problemId();
	}
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.TypeBinding#qualifiedPackageName()
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.TypeBinding#qualifiedSourceName()
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.Binding#readableName()
	 */
	...
	ReferenceBinding resolve() {
		...
		if (this.arguments != null) {
			...
			/* https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=186565, Removed generic check
...
//			}
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.Binding#shortReadableName()
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.TypeBinding#nullAnnotatedReadableName(CompilerOptions,boolean)
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.TypeBinding#signature()
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.TypeBinding#sourceName()
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.Substitution#substitute(SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.TypeVariableBinding)
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#superclass()
	 */
	public ReferenceBinding superclass() {
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#superInterfaces()
	 */
	public ReferenceBinding[] superInterfaces() {
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#syntheticEnclosingInstanceTypes()
	 */
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding#syntheticOuterLocalVariables()
	 */
