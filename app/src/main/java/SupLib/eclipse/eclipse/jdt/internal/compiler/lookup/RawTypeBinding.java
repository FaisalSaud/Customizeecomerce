...
public class RawTypeBinding extends ParameterizedTypeBinding {
	...
	/**
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ParameterizedTypeBinding#createParameterizedMethod(SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.MethodBinding)
	 */
    ...
    public boolean isProvablyDistinct(TypeBinding otherType) {
		if (TypeBinding.equalsEquals(this, otherType) || TypeBinding.equalsEquals(erasure(), otherType)) // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=329588
		    return false;
	    if (otherType == null)
	        return true;
	    switch(otherType.kind()) {
