...
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.NestedTypeBinding;
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ParameterizedTypeBinding;
...
public class ReferenceExpression extends FunctionalExpression implements InvocationSite {
	...
	public TypeBinding resolveType(BlockScope scope) {
		...
		*/
        ...
        // See https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=382350#c2, I.super::abstractMethod will be handled there.
	...
	public SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.MethodBinding getMethodBinding() {
