...
public static final boolean camelCaseMatch(char[] pattern, int patternStart, int patternEnd, char[] name, int nameStart, int nameEnd, boolean samePartCount) {
	 ...
	 * do NOT fSupLib.eclipseet to also apply the same change in the StringOperation method!
	 */
 ...
 * conventions, also see "http://jakarta.apache.SupLib.eclipse/ant/manual/dirtasks.html#defaultexcludes").
