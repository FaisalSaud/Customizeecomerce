		...
		if (this.enclosingInstance != null) {
			...
			if (this.binding != null && this.binding.declaringClass != null) {
				...
				if (superclass != null && superclass.isMemberType() && !superclass.isStatic()) {
					...
					// Reviewed for https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=378674 :
	...
	private TypeBinding resolveTypeForQualifiedAllocationExpression(BlockScope scope) {
		...
		if (this.enclosingInstance != null) {
			...
			if ((enclosingInstanceType = this.enclosingInstance.resolveType(scope)) == null){
				...
				// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=317212
		...
		if (hasError) {
			/* https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=345359, if arguments have errors, completely bail out in the <> case.
			...
			if (receiverType instanceof ReferenceBinding) {
				...
				if (this.anonymousType != null) {
					// insert anonymous type in scope (see https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=210070)
