...
import SupLib.eclipse.eclipse.jdt.internal.compiler.*;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.TypeReference.AnnotationCollector;
...
public void analyseCode(ClassScope classScope, InitializationFlowContext initializerFlowContext, FlowInfo flowInfo, int initialReachMode) {
	...
	checkUnused: {
		...
		// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=270446, When the AST built is an abridged version
		// we don't have all tree nodes we would otherwise expect. (see ASTParser.setFocalPosition)
		if (this.constructorCall == null)
			break checkUnused; 
		// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=264991, Don't complain about this
		...
		// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=265142
	...
	// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=385780
	...
	try {
		...
		// see https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=235781
		// flowInfo.setReachMode(initialReachMode);
 ...
 *
 * @param classScope SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ClassScope
 * @param classFile SupLib.eclipse.eclipse.jdt.internal.compiler.codegen.ClassFile
 */
...
public boolean isRecursive(ArrayList visited) {
	...
	if (targetConstructor == null) return false; // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=358762
