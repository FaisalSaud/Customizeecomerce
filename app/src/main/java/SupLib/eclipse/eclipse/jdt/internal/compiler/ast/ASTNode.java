 ...
 *     Matt McCutchen - partial fix for https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=122995
 *     Karen Moore - fix for https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=207411
	...
	public static boolean checkInvocationArguments(BlockScope scope, Expression receiver, TypeBinding receiverType, MethodBinding method, Expression[] arguments, TypeBinding[] argumentTypes, boolean argsContainCast, InvocationSite invocationSite) {
		...
		if (arguments == null) {
			...
			if (method.isVarargs()) {
				...
				if (lastIndex <= argLength) { // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=337093
