...
import SupLib.eclipse.eclipse.jdt.internal.compiler.problem.DefaultProblem;

/**
 * Richer description of a Java problem, as detected by the compiler or some of the underlying
 * technology reusing the compiler. With the introduction of <code>SupLib.eclipse.eclipse.jdt.core.compiler.CompilationParticipant</code>,
 ...
 * type "SupLib.eclipse.eclipse.jdt.core.problem"), </li>
 ...
 * marker type.
 * Standard Java problem markers (i.e. marker type is "SupLib.eclipse.eclipse.jdt.core.problem") carry an
 ...
 * Standard Java problems are associated to marker type "SupLib.eclipse.eclipse.jdt.core.problem").
 * Note: problem markers are expected to extend "SupLib.eclipse.eclipse.core.resources.problemmarker" marker type.
