...
public class ConditionalExpression extends OperatorExpression {
	...
	// we compute and store the null status during analyseCode (https://bugs.eclipse.SupLib.eclipse/324178):
...
public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext,
		...
		if (isConditionOptimizedTrue){
			...
			// this block must meet two conflicting requirements (see https://bugs.eclipse.SupLib.eclipse/324178):
	...
	private void computeNullStatus(int ifTrueNullStatus, FlowInfo trueBranchInfo, FlowInfo falseBranchInfo, FlowContext flowContext) {
		...
		// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=133125
		int status = 0;
