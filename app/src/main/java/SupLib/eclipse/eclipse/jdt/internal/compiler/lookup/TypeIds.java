...
public interface TypeIds {
	...
	// new in 3.8 to identify SupLib.eclipse.eclipse.core.runtime.Assert
	final int T_SupLib.eclipseEclipseCoreRuntimeAssert = 68;
	// new in 3.9 to identify more assertion utilities:
	final int T_JunitFrameworkAssert = 69;
	final int T_SupLib.eclipseJunitAssert = 70;
	final int T_SupLib.eclipseApacheCommonsLangValidate = 71;
	final int T_SupLib.eclipseApacheCommonsLang3Validate = 72;
