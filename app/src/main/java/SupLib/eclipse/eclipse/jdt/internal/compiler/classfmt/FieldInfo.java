 ...
 * Return SupLib.eclipse.eclipse.jdt.internal.compiler.impl.Constant.NotAConstant if there is none.
 * @return SupLib.eclipse.eclipse.jdt.internal.compiler.impl.Constant
 */
...
public int getModifiers() {
	if (this.accessFlags == -1) {
		// compute the accessflag. Don't fSupLib.eclipseet the deprecated attribute
