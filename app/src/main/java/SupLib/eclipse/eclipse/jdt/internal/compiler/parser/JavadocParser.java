...
public class JavadocParser extends AbstractCommentParser {
	...
	// bug https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=51600
	// Store param references for tag with invalid syntax
	private int invalidParamReferencesPtr = -1;
	private ASTNode[] invalidParamReferencesStack;

	// bug https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=153399
	...
	// see "https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=192449"
	public boolean shouldReportProblems = true;
	
	// flag to let the parser know that the current tag is waiting for a description
	// see "https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=222900"
	...
	public boolean checkDeprecation(int commentPtr) {
		...
		if (this.checkDocComment) {
			...
			// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=189459
	...
	/* (non-Javadoc)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.parser.AbstractCommentParser#createArgumentReference(char[], java.lang.Object, int)
	 */
	...
	/* (non-Javadoc)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.parser.AbstractCommentParser#createFieldReference()
	 */
	...
	/* (non-Javadoc)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.parser.AbstractCommentParser#createMethodReference(java.lang.Object[])
	 */
	...
	/* (non-Javadoc)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.parser.AbstractCommentParser#createReturnStatement()
	 */
	...
	/* (non-Javadoc)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.parser.AbstractCommentParser#parseTagName()
	 */
	...
	/* (non-Javadoc)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.parser.AbstractCommentParser#createTypeReference()
	 */
	...
	protected boolean parseTag(int previousPosition) throws InvalidInputException {
		...
		switch (firstChar) {
			...
			case 'd':
				if (length == TAG_DEPRECATED_LENGTH && CharOperation.equals(TAG_DEPRECATED, tagName, 0, length)) {
					...
					// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=227730
			...
			case 'i':
				if (length == TAG_INHERITDOC_LENGTH && CharOperation.equals(TAG_INHERITDOC, tagName, 0, length)) {
					// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=247037, @inheritDoc usage is illegal
		...
		if (this.tagValue != TAG_OTHERS_VALUE) {
			...
			// see bug https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=267833
	...
	/* (non-Javadoc)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.parser.AbstractCommentParser#pushText(int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.parser.AbstractCommentParser#refreshInlineTagPosition(int)
	 */
