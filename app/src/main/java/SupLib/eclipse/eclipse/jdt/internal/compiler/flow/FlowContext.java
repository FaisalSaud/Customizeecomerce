 ...
 *******************************************************************************/
package SupLib.eclipse.eclipse.jdt.internal.compiler.flow;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.SubRoutineStatement;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.codegen.BranchLabel;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.CatchParameterBinding;
...
/**
 * FSupLib.eclipseet any information about fields that were previously known to be non-null.
 * 
...
public void checkExceptionHandlers(TypeBinding raisedException, ASTNode location, FlowInfo flowInfo, BlockScope scope, boolean isExceptionOnAutoClose) {
	...
	if (scope.compilerOptions().sourceLevel >= ClassFileConstants.JDK1_7 && location instanceof ThrowStatement) {
		...
		if (throwExpression instanceof SingleNameReference // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=350361
