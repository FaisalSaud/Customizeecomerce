...
public char[] constantPoolName() /* java/lang/Object */ {
	...
	if (this.constantPoolName == null && this.scope != null) {
		// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=322154, we do have some
 ...
 * (see https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=99686)
 */
 ...
 * Overriden for code assist. In this case, the constantPoolName() has not been computed yet.
 * Slam the source name so that the signature is syntactically correct.
 * (see https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=102284)
 */
