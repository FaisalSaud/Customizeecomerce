...
import SupLib.eclipse.eclipse.jdt.internal.compiler.flow.ExceptionHandlingFlowContext;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.AnnotationBinding;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.PolyTypeBinding;
...
import SupLib.eclipse.eclipse.jdt.internal.compiler.problem.AbortMethod;
import SupLib.eclipse.eclipse.jdt.internal.compiler.problem.AbortType;
...
public class LambdaExpression extends FunctionalExpression implements ReferenceContext, ProblemSeverities {
	 ...
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.MethodScope.createMethod(AbstractMethodDeclaration)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.SourceTypeBinding.resolveTypesFor(MethodBinding)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.ast.AbstractMethodDeclaration.resolve(ClassScope)
	 */
