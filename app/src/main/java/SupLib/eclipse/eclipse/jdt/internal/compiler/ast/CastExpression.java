...
public boolean checkUnsafeCast(Scope scope, TypeBinding castType, TypeBinding expressionType, TypeBinding match, boolean isNarrowing) {
	...
	switch (castType.kind()) {
		...
		case Binding.TYPE_PARAMETER :
			this.bits |= ASTNode.UnsafeCast;
			return true;
//		(disabled) https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=240807
//		case Binding.TYPE :
...
/**
 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.ast.Expression#localVariableBinding()
 */
...
/**
 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.ast.Expression#optimizedBooleanConstant()
 */
...
/**
 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.ast.Expression#tagAsNeedCheckCast()
 */
