...
public SourceTypeBinding(char[][] compoundName, PackageBinding fPackage, ClassScope scope) {
	...
	this.prototype = this;
	computeId();
	if (this.isAnnotationType()) { // for forward references, see https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=419331
...
/*
 * https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=288658. Generate a bridge method if a public method is inherited
 * from a non-public class into a public class (only in 1.6 or greater)
 * https://bugs.eclipse.SupLib.eclipse/404690 : this doesn't apply to inherited interface methods (i.e., default methods)
 */
...
/**
 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.TypeBinding#genericTypeSignature()
 */
 ...
 * declaration binding.
 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.Binding#getAnnotationTagBits()
 */
...
/**
 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.Binding#initializeDeprecatedAnnotationTagBits()
 */
...
public MethodBinding[] methods() {
	...
	if (!areMethodsInitialized()) { // https://bugs.eclipse.SupLib.eclipse/384663
		this.scope.buildMethods();
	}
	...
	try {
		...
		for (int i = 0, length = this.methods.length; i < length; i++) {
			...
			nextSibling: for (int j = i + 1; j < length; j++) {
				...
				if (complyTo15OrAbove) {
					if (method.areParameterErasuresEqual(method2)) {
						...
						// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=317719
			...
			if (method.returnType == null && resolvedMethods[i] != null) { // fSupLib.eclipseet method with invalid return type... was kept to detect possible collisions
...
public MethodBinding resolveTypesFor(MethodBinding method) {
	...
	if (arguments != null) {
		...
		for (int i = 0; i < size; i++) {
			...
			// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=322817
	...
	// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=337799
	if (sourceLevel >= ClassFileConstants.JDK1_7) {
		...
		} else if (method.parameters != null && method.parameters.length > 0 && method.isVarargs()) { // https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=337795
	...
	if (foundArgProblem) {
		...
		// (see https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=81134)
		if (typeParameters != null)
...
// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=391108
...
public void tagIndirectlyAccessibleMembers() {
	...
	// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=328281
