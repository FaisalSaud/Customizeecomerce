	...
	private TypeBinding internalResolveType(Scope scope) {
		...
		if (this.argument != null) {
			...
			if (typeRef != null) {
				...
				// see https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=195374
				...
				if (typeRef instanceof SingleTypeReference &&
					...
					// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=228648
					...
					if (enclosingType != null) {
						// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=233187
