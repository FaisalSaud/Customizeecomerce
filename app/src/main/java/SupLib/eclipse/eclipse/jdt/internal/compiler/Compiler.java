...
import SupLib.eclipse.eclipse.jdt.internal.compiler.impl.*;
import SupLib.eclipse.eclipse.jdt.internal.compiler.ast.*;
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.*;
import SupLib.eclipse.eclipse.jdt.internal.compiler.parser.*;
import SupLib.eclipse.eclipse.jdt.internal.compiler.problem.*;
import SupLib.eclipse.eclipse.jdt.internal.compiler.util.*;
...
public class Compiler implements ITypeRequestor, ProblemSeverities {
	 ...
	 *
	 *  @param environment SupLib.eclipse.eclipse.jdt.internal.compiler.api.env.INameEnvironment
	 ...
	 *            rules.
	 *
	 *  @param policy SupLib.eclipse.eclipse.jdt.internal.compiler.api.problem.IErrorHandlingPolicy
	 *      Configurable part for problem handling, allowing the compiler client to
	 *      specify the rules for handling problems (stop on first error or accumulate
	 *      them all) and at the same time perform some actions such as opening a dialog
	 *      in UI when compiling interactively.
	 *      @see SupLib.eclipse.eclipse.jdt.internal.compiler.DefaultErrorHandlingPolicies
	 *
	 *  @param settings java.util.Map
	 *      The settings that control the compiler behavior.
	 *
	 *  @param requestor SupLib.eclipse.eclipse.jdt.internal.compiler.api.ICompilerRequestor
	 *      Component which will receive and persist all compilation results and is intended
	 *      to consume them as they are produced. Typically, in a batch compiler, it is
	 *      responsible for writing out the actual .class files to the file system.
	 *      @see SupLib.eclipse.eclipse.jdt.internal.compiler.CompilationResult
	 *
	 *  @param problemFactory SupLib.eclipse.eclipse.jdt.internal.compiler.api.problem.IProblemFactory
	 ...
	 *      @see SupLib.eclipse.eclipse.jdt.internal.compiler.DefaultErrorHandlingPolicies
	 *
	 *  @param options SupLib.eclipse.eclipse.jdt.internal.compiler.impl.CompilerOptions
		...
		try {
			...
			if (unit.scope != null) {
				...
				if (unit.scope != null && verifyMethods) {
					// http://dev.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=23117
 					// verify inherited methods
					unit.scope.verifyMethods(this.lookupEnvironment.methodVerifier());
				}
				// type checking
