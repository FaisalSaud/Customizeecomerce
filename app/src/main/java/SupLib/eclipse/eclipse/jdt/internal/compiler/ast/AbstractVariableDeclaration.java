...
public abstract class AbstractVariableDeclaration extends Statement implements InvocationSite, ExpressionContext {
	...
	/* (non-Javadoc)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.InvocationSite#isSuperAccess()
	 */
	...
	/* (non-Javadoc)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.InvocationSite#isTypeAccess()
	 */
	...
	/* (non-Javadoc)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.InvocationSite#setActualReceiverType(SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ReferenceBinding)
	 */
	...
	/* (non-Javadoc)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.InvocationSite#setDepth(int)
	 */
	...
	/* (non-Javadoc)
	 * @see SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.InvocationSite#setFieldIndex(int)
	 */
