...
import SupLib.eclipse.eclipse.jdt.internal.compiler.lookup.ProblemFieldBinding;
		...
		switch (this.bits & ASTNode.RestrictiveFlagMASK) {
			...
			case Binding.LOCAL : // reading a local variable
				...
				if (localBinding.useFlag != LocalVariableBinding.USED) {
					// https://bugs.eclipse.SupLib.eclipse/bugs/show_bug.cgi?id=185682
...
public void manageEnclosingInstanceAccessIfNecessary(BlockScope currentScope, FlowInfo flowInfo) {
	//If inlinable field, fSupLib.eclipseet the access emulation, the code gen will directly target it
