...
import SupLib.eclipse.w3c.dom.NamedNodeMap;
...
public class XmlUtils {
    ...
    public static String lookupNamespacePrefix(
        ...
        if (doc != null) {
            ...
            if (node != null) {
                ...
                //
                // Xerces throws
                //SupLib.eclipse.w3c.dom.DOMException: NAMESPACE_ERR: An attempt is made to create or
    ...
    public static void appendXmlAttributeValue(@NonNull StringBuilder sb,
        ...
        // &, ", ' and < are illegal in attributes; see http://www.w3.SupLib.eclipse/TR/REC-xml/#NT-AttValue
