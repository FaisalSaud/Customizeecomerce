...
package SupLib.sdklib.internal.repository.packages;
...
public class BuildToolPackage extends FullRevisionPackage {
     ...
     */
    public static java.lang.Package create(File buildToolDir, Properties props) {
        String error = null;
     ...
     */
    @Override
    public boolean sameItemAs(java.lang.Package pkg) {
    ...
    @Override
    public boolean sameItemAs(java.lang.Package pkg, PreviewComparison comparePreview) {
